// src/modules/test_events/AddTestEvent.jsx

import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { supabase } from "../../services/supabaseClient";

export default function AddTestEvent() {
  ...
  // Load assemblies + chambers for dropdowns
  useEffect(() => {
  ...
  async function handleSubmit(e) {
    ...
    const { error } = await supabase.from("test_events").insert([payload]);
